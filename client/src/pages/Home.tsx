...
function ReferenceBoard({ chapterKey }: { chapterKey: JourneyKey }) {
  ...
  if (chapterKey === "versions") return <div className="reference-board reference-collaboration"><div className="ref-branch-card main"><b>MAINLINE</b><small>v1.4 · approved</small><Garment mode="mini" material="silver" /></div><div className="ref-branch-card"><b>CREATIVE BRANCH</b><small>v1.5-C · longer drape</small><Garment mode="mini" material="matte" /></div><div className="ref-branch-card"><b>PRODUCTION BRANCH</b><small>v1.5-T · simplified construction</small><Garment mode="mini" material="silver" /></div><div className="ref-comments"><b>COMMENTS</b><span>Creative Director<small>Preserve the collar volume.</small></span><span>Pattern Engineer<small>Can we simplify the seam?</small></span><span>Product Manager<small>Check sleeve mobility.</small></span></div></div>;
