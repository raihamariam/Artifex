...
const journeyChapters = [
  { key: "creative", phase: "Creative", title: "Interpret creative intent", body: "Liquid Architecture begins as a futuristic evening look: architectural through the collar and sleeves, cinched at the waist, and fluid through the asymmetric drape.", environment: "editorial development" },
  { key: "versions", phase: "Collaboration", title: "Evolve the garment without losing intent", body: "Mainline, Creative and Technical branches remain descendants of GARMENT / 001, carrying the collar, waist proportion, material direction, and drape decisions with them.", environment: "collaboration repository" },
  { key: "understanding", phase: "Creative", title: "Make Liquid Architecture legible", body: "Artifex reads the oversized collar, volume sleeve, twisted waist, drape panel, and fitted mini base as one connected garment system.", environment: "garment reading" },
  { key: "fit", phase: "Engineering", title: "Validate the garment on the body", body: "Collar clearance, shoulder balance, sleeve mobility, waist compression, hip ease, and drape fall are checked on the same silver look across AU 6–16.", environment: "fit / body relationship" },
  { key: "engineering", phase: "Engineering", title: "Engineer the silhouette", body: "Artifex diagnoses collar support, sleeve volume, waist convergence, drape integration, and base-body constraints before proposing alternatives.", environment: "garment logic" },
  { key: "pattern", phase: "Engineering", title: "One design. Multiple engineering routes.", body: "Structural collar, wrapped bodice, upper sleeve, waist anchor, asymmetric drape, mini base, lining, and reinforcement pieces unfold from the same garment.", environment: "pattern engineering" },
  ...
  { key: "materials", phase: "Materials", title: "Connect every component", body: "The metallic laminated satin shell, technical lining, collar support, sleeve reinforcement, concealed zip, and waist tape become intelligent product objects.", environment: "materials / behaviour" },
  { key: "textile", phase: "Materials", title: "Material changes the product", body: "Laminated Metallic Technical Satin preserves collar authority and sleeve volume; a Metallic Silk-Viscose Blend softens structure and deepens the drape.", environment: "textile behaviour" },
  ...
  { key: "production", phase: "Production", title: "Preserve the design. Improve the build.", body: "Fourteen conceptual pattern pieces are nested around the collar, sleeve support, twisted waist, and asymmetric drape to improve utilisation without sacrificing movement.", environment: "production / optimisation" },
  { key: "bom", phase: "Production", title: "Turn the garment into production knowledge", body: "The live BOM connects metallic shell, lining, interfacing, sleeve support, concealed zip, high-strength thread, and waist stabilisation tape to the garment.", environment: "documentation / release package" },
  ...
  { key: "release", phase: "Release", title: "Cross the approval boundary", body: "A production approver unlocks release when the final pattern, material behaviour, fit, construction, BOM, costing, and documentation agree around Liquid Architecture.", environment: "release gate" },
  ...
  { key: "community", phase: "Community", title: "Share structured fashion work", body: "Liquid Architecture enters the ecosystem as a released product graph: discover, fork, remix, collaborate, and hire without losing the original silhouette or creator lineage.", environment: "community ecosystem" },
] as const;
...
const copilotContexts: Record<JourneyKey, { prompt: string; context: string; stages: string[]; outcome: string }> = {
  creative: { prompt: "Create a futuristic evening look like liquid metal shaped into architecture—powerful through the shoulders, controlled at the waist, fluid when she moves.", context: "Liquid Architecture / creative intent", stages: ["Reading liquid-metal references", "Identifying collar and sleeve volume", "Mapping twisted waist and drape", "Creating a structured garment intent"], outcome: "Liquid Architecture intent mapped onto GARMENT / 001" },
  understanding: { prompt: "What is happening in the twisted waist and asymmetric drape?", context: "Waist anchor / asymmetric drape panel", stages: ["Reading selected region", "Tracing directional folds", "Checking waist convergence", "Checking movement behaviour"], outcome: "Drape movement is anchored at the waist while the fitted mini base supports the silhouette" },
  versions: { prompt: "Increase collar projection without changing the waist proportion.", context: "MAINLINE v1.4 / collar + waist locked", stages: ["Comparing garment descendants", "Preserving waist proportion", "Checking collar support", "Recording branch lineage"], outcome: "A non-destructive creative branch is ready for review" },
  fit: { prompt: "Can the sleeves gain mobility without changing the silhouette?", context: "AU 8–16 / sleeve mobility + waist compression", stages: ["Reading fit checkpoints", "Checking shoulder interaction", "Inspecting sleeve range", "Testing drape clearance"], outcome: "Increase rear sleeve mobility by approximately 12 mm" },
  engineering: { prompt: "Keep the collar, waist, and drape exactly recognizable. Show safer construction routes.", context: "Liquid Architecture / garment logic", stages: ["Locking creative constraints", "Testing collar support", "Checking waist convergence", "Generating production-safe options"], outcome: "Three engineering interpretations of the same silhouette generated" },
  pattern: { prompt: "Show the lowest-risk route that preserves the sculptural collar and asymmetric drape.", context: "Pattern routes / collar + drape + mini base", stages: ["Comparing pattern strategies", "Checking internal support", "Testing fit preservation", "Re-ranking construction risk"], outcome: "Balanced Engineering is recommended at 95% creative fidelity" },
  ...
  materials: { prompt: "What happens if I use the softer metallic silk-viscose blend?", context: "Laminated Metallic Technical Satin / current garment", stages: ["Creating textile twin", "Simulating collar and sleeve behaviour", "Checking drape and pattern validity", "Comparing cost and structure"], outcome: "Softer material increases fluidity but requires additional collar support" },
  textile: { prompt: "Preserve the collar authority while giving the drape more movement.", context: "Technical satin / metallic silk-viscose twin", stages: ["Measuring movement signature", "Adjusting panel geometry", "Testing material behaviour", "Re-simulating the same garment"], outcome: "Material strategy updated: collar rigidity −21%, drape fluidity +34%" },
  propagation: { prompt: "Show everything this fabric change affects in Liquid Architecture.", context: "Metallic silk-viscose substitution", stages: ["Tracing Product Graph", "Updating drape and fit", "Recalculating pattern and consumption", "Refreshing cost and documentation"], outcome: "Material → drape → fit → pattern → construction → cost → documentation updated" },
  ...
  production: { prompt: "Reduce fabric waste without shortening the asymmetric drape or changing the visible silhouette.", context: "GARMENT / 001 / 14-piece marker", stages: ["Evaluating collar and drape layouts", "Checking directional grain", "Nesting sleeve support pieces", "Refreshing utilisation and waste"], outcome: "Fabric utilisation improves from approximately 73% to 86%" },
  bom: { prompt: "Prepare Liquid Architecture for factory review.", context: "GARMENT / 001 / approved product state", stages: ["Generating technical flats", "Building live BOM", "Packaging AU 6–16 grading", "Adding sleeve mobility and waist QC"], outcome: "Factory review package assembled around the silver garment" },
  ...
  costing: { prompt: "Get Liquid Architecture below $115 without changing the metallic shell.", context: "Landed cost $120.28 / laminated satin locked", stages: ["Locking metallic shell", "Testing collar construction path", "Testing supplier substitution", "Combining trim and marker savings"], outcome: "Path 03 reaches $113.90 without reducing the visible drape" },
  ...
  community: { prompt: "Fork the asymmetric drape into a new exploration without losing Liquid Architecture’s history.", context: "GARMENT / 001 / released product graph", stages: ["Preserving source lineage", "Creating a non-destructive branch", "Attaching Artifex attribution", "Opening a structured remix"], outcome: "A new garment lineage is created without breaking the original product truth" },
...
function Garment({ mode = "hero", material = "silver", pattern = false }: { mode?: "hero" | "studio" | "mini"; material?: string; pattern?: boolean }) {
  return (
    <div className={`garment-scene ${mode} material-${material} ${pattern ? "is-pattern" : ""}`}>
      <img className="canonical-garment-image" src="/manus-storage/artifex-liquid-architecture-editorial-cutout_9e8d8ac2.png" alt="Liquid Architecture canonical silver sculptural garment" draggable={false} />
    ...
    <main className={`journey-page immersive-journey mode-explore env-${key}`}>
      ...
      <section className="immersive-layout">
        ...
        <div className={`persistent-stage stage-${key} ${copilotPulse ? "copilot-changing" : ""}`} onPointerDown={(e) => { dragging.current = true; (e.currentTarget as HTMLElement).setPointerCapture(e.pointerId); }} onPointerMove={(e) => { if (!dragging.current) return; dragDelta.current += e.movementX * .45; if (dragFrame.current === null) { dragFrame.current = window.requestAnimationFrame(() => { dragFrame.current = null; const delta = dragDelta.current; dragDelta.current = 0; setRotation((r) => r + delta); }); } }} onPointerUp={() => { dragging.current = false; }} onPointerCancel={() => { dragging.current = false; }}>
          ...
          {key === "creative" && <div className="creative-board"><span className="board-card mood">LIQUID METAL<small>architectural folds · reflection</small></span><span className="board-card sketch">INTENT SKETCH<small>collar · sleeve · twisted waist</small></span><span className="board-card intent">CREATIVE INTENT<small>rigid upper volume · fluid drape</small></span></div>}
          {key === "understanding" && <div className="garment-callouts"><button onClick={() => setSelectedRegion("Sculptural collar / shape-retention critical")}>Sculptural collar</button><button onClick={() => setSelectedRegion("Asymmetric drape panel / free-hanging movement")}>Asymmetric drape</button><button onClick={() => setSelectedRegion("Twisted waist / convergence point")}>Twisted waist</button><button onClick={() => setSelectedRegion("Volume sleeve / mobility risk")}>Volume sleeve</button><button onClick={() => setSelectedRegion("Structured mini base / fitted support")}>Structured mini base</button></div>}
          {key === "versions" && <div className="collaboration-scene"><div className="collab-header"><span>COLLABORATION / REPOSITORY</span><b>Evolve the garment without losing intent.</b></div><div className="collab-repository"><div className="collab-branch mainline"><b>MAINLINE</b><small>v1.4 · collar + waist locked · drape under review</small></div><div className="collab-branch creative-branch"><b>CREATIVE BRANCH</b><small>v1.5-C · +18% drape · +10% collar projection</small></div><div className="collab-branch production-branch"><b>TECHNICAL BRANCH</b><small>v1.5-T · simplified support · adjusted attachment</small></div><div className="collab-version-card creative-card"><Garment mode="mini" material="matte" /><span>CREATIVE DESCENDANT</span><small>Push the drama without losing the waist.</small></div><div className="collab-garment"><Garment mode="studio" material="silver" /></div><div className="collab-version-card production-card"><Garment mode="mini" material="silver" /><span>TECHNICAL DESCENDANT</span><small>Preserve silhouette, reduce complexity.</small></div><div className="collab-region-note shoulder-note"><i />COLLAR · increase projection?</div><div className="collab-region-note seam-note"><i />WAIST · do not change proportion.</div><div className="collab-review">REVIEW / APPROVAL <b>Version 1.6 · merge candidate</b><small>Ready for engineering review · creative intent preserved</small></div><div className="collab-merge-card"><Garment mode="mini" material="silver" /><b>MERGE CANDIDATE 1.6</b><small>Collar, drape, waist, and sleeve checks attached</small></div><div className="collab-merge-arrow">↓</div></div><div className="collab-versions"><span>CREATE</span><span className="active">COMPARE VERSIONS</span><span>COMMENT</span><span>REVIEW</span><span>APPROVE</span><span>MERGE</span><span>ROLLBACK</span></div></div>}
          {key === "fit" && <><div className="avatar-sizes"><span>AU 6</span><span>AU 8</span><span className="active">AU {size}</span><span>AU 12</span><span>AU 16</span></div><div className="fit-alert">FIT CHECK / SLEEVE MOBILITY MODERATE RISK / WAIST CONTROLLED</div></>}
          {key === "engineering" && <div className="constraint-hud"><span>COLLAR<b>Shape-retention critical</b></span><span>WAIST<b>High compression / seam convergence</b></span><span>DRAPE PANEL<b>Movement priority / low structure</b></span></div>}
          {key === "pattern" && <div className="pattern-alternatives">{["A","B","C"].map((item) => <button key={item} className={pattern === item ? "active" : ""} onClick={() => setPattern(item)}><span>{item}</span><i>{item === "A" ? "Couture structure" : item === "B" ? "Balanced engineering" : "Production simplified"}</i><small>{item === "A" ? "98% fidelity · high complexity" : item === "B" ? "95% fidelity · recommended" : "87% fidelity · low complexity"}</small></button>)}</div>}
          ...
          {key === "materials" && <div className="material-orbit"><span>SHELL<small>Laminated metallic technical satin</small></span><span>LINING<small>Lightweight technical lining</small></span><span>COLLAR SUPPORT<small>Structured interfacing</small></span><span>WAIST TAPE<small>Stabilisation / anchor</small></span></div>}
          {key === "textile" && <div className="textile-twin"><div><Garment mode="mini" material="silver" /><span>METALLIC TECHNICAL SATIN<small>high structure · controlled drape · primary</small></span></div><div><Garment mode="mini" material="matte" /><span>METALLIC SILK-VISCOSE<small>high fluidity · softer collar · support required</small></span></div></div>}
          ...
          {key === "production" && <div className={`marker-layout ${productionOptimised ? "optimised" : ""}`}><span /><span /><span /><span /><span /><b>{productionOptimised ? "86%" : "73%"}<small>FABRIC UTILISATION</small></b></div>}
          {key === "bom" && <div className={`document-cloud ${documentsReady ? "package-ready" : ""}`}><span>TECH PACK</span><span>AU 6–16 GRADING</span><span>LIVE BOM</span><span>COLLAR SUPPORT</span><span>WAIST TAPE</span><span>QC / SLEEVE MOBILITY</span>{documentsReady && <b><Check size={14} /> FACTORY REVIEW PACKAGE READY</b>}</div>}
          ...
          {key === "community" && <div className="community-scene"><div className="community-label"><span>COMMUNITY / ECOSYSTEM</span><b>Share Liquid Architecture.</b><small>Fork the released silver garment into recognizable descendants while preserving creator credit and editable engineering knowledge.</small></div><div className="community-ecosystem"><div className="community-project-card project-vest"><i />LONGER DRAPE<small>fork · 118% panel length</small></div><div className="community-project-card project-top"><i />SOFT COLLAR<small>remix · silk-viscose</small></div><div className="community-project-card project-pant"><i />READY-TO-WEAR<small>fork · simplified build</small></div><div className="community-project-card project-coat"><i />EXTREME VOLUME<small>remix · editorial</small></div><div className="community-creator creator-discover">◉<b>DISCOVER</b><small>New structured<br />projects</small></div><div className="featured-project"><span>RELEASED PROJECT</span><Garment mode="mini" material="silver" /><b>LIQUID ARCHITECTURE / 001</b><small>ARTIFEX · silver ready-to-wear / editable graph</small></div><div className="community-creator creator-share">◇<b>SHARE</b><small>Publish the<br />product graph</small></div><div className="community-creator creator-fork">⌘<b>FORK</b><small>Start a new<br />lineage</small></div><div className="community-creator creator-remix">△<b>REMIX</b><small>Explore material<br />interpretations</small></div><div className="community-creator creator-collaborate">◉<b>COLLABORATE</b><small>Work with<br />specialists</small></div><div className="community-creator creator-hire">♧<b>HIRE</b><small>Find makers<br />& factories</small></div><div className="creator-lineage">CREATOR ATTRIBUTION <b>ARTIFEX · GARMENT / 001</b><small>Every fork preserves the original silhouette, history, and editable intelligence.</small></div></div></div>}
        ...
        <aside className="action-panel">
          ...
          {key === "creative" && <><h3>Liquid Architecture</h3><p>Reflective metallic surface<br />Sculptural collar + sleeves<br />Cinched twisted waist<br />Asymmetric fluid drape</p><button className="action-primary" onClick={() => go(1)}>Interpret design <ArrowRight size={14} /></button></>}
          ...
          {key === "versions" && <><h3>Repository status</h3><p>MAINLINE <b>v1.4</b><br />Creative branch <b>v1.5-C</b><br />Technical branch <b>v1.5-T</b></p><div className="repo-status"><span>● collar + waist locked</span><span>○ drape under review</span><span>● v1.6 merge candidate</span></div><button className="action-primary">Review merge candidate <ArrowRight size={14} /></button><div className="recent-comments"><span className="recent-comments-label">RECENT COMMENTS</span><article><b>Jordan Lee <small>Creative Director · collar · 2h ago</small></b><p>“Can we increase projection without adding too much weight?”<br /><em>Creative branch / sculptural collar</em></p></article><article><b>Maya Kim <small>Technical Designer · waist · 5h ago</small></b><p>“Do not change this proportion.”<br /><em>Mainline / twisted waist anchor</em></p></article><article><b>Devon Tran <small>Production Lead · drape · 1d ago</small></b><p>“Keep movement but reduce fabric bulk.”<br /><em>Technical branch / asymmetric drape</em></p></article></div></>}
          ...
          {key === "engineering" && <><h3>Engineer the silhouette</h3><p>Preserve collar drama, waist definition, sleeve volume, and asymmetric movement while reducing construction risk.</p><button className="action-primary" onClick={() => go(5)}>Compare 3 routes</button></>}
          ...
          {key === "textile" && <><h3>Compare fabric reality</h3><div className="choice-row"><button className={material === "silver" ? "selected" : ""} onClick={() => setMaterial("silver")}>Technical satin</button><button className={material === "matte" ? "selected" : ""} onClick={() => setMaterial("matte")}>Silk-viscose</button></div><p>{material === "matte" ? "Collar rigidity −21% · drape fluidity +34% · one extra interfacing layer." : "High shape retention · controlled drape · primary material."}</p><button className="action-primary" onClick={() => { setMaterial("matte"); go(10); }}>Propagate material change</button></>}
          ...
          {key === "production" && <><h3>Marker efficiency</h3><p>{productionOptimised ? "Fabric utilisation 86% / waste 14% / +13 points" : "Initial utilisation 73% / waste 27%"}</p><button className="action-primary" onClick={() => setProductionOptimised(true)}>{productionOptimised ? "Optimised / 86%" : "Optimise"}</button></>}
          {key === "bom" && <><h3>Live BOM / release package</h3><p>Metallic satin shell 2.7m<br />Technical lining 1.4m<br />Structured collar support<br />Concealed side zip + waist tape</p><button className="action-primary">Generate documentation</button></>}
          ...
          {key === "costing" && <><h3>{costPath ? "Target achieved / $113.90" : "Liquid Architecture cost"}</h3><div className="choice-row"><button>1K</button><button>5K</button><button className="selected">10K</button><button>50K</button></div><p>{costPath ? "Path 03 combines trim and marker optimisation while protecting the drape panel." : "The metallic shell, construction labour, and structural support are the major cost drivers."}</p></>}
          ...
          {key === "community" && <><span className="panel-label">PROJECT / COMMUNITY</span><h3>Liquid Architecture / 001</h3><p>A released, structured garment project with editable engineering knowledge.</p><div className="community-project-preview"><div className="preview-garment"><Garment mode="mini" material="silver" /></div><div><b>Liquid Architecture</b><small>by Artifex · GARMENT / 001 <i>●</i></small></div></div><div className="community-meta"><span>Garment type <b>Futuristic evening / RTW</b></span><span>Material <b>Laminated metallic technical satin</b></span><span>Status <b><i>●</i> Released / lineage live</b></span><span>Availability <b>Fork, Remix, Collaborate, Hire</b></span></div><div className="community-actions"><button>Fork garment <ArrowRight size={13} /></button><button>Request collaboration <ArrowRight size={13} /></button><button>Hire maker / factory <ArrowRight size={13} /></button><button>Save to collection <ArrowRight size={13} /></button></div><div className="community-metrics"><b>8<small>forks</small></b><b>5<small>collaborators</small></b><b>3<small>material remixes</small></b><b>2<small>factory matches</small></b></div><button className="action-primary" onClick={() => go(25)}>Continue to ending <ArrowRight size={14} /></button></>}
