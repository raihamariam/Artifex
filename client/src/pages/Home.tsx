  ...
  return (
    <main className="landing-page">
      ...
      <section className="principle-section" id="principle">
        ...
        <div className="principle-visual graph-expanded supplied-figure-graph"><div className="principle-ring ring-outer" /><div className="principle-ring ring-inner" /><div className="principle-core supplied-figure-core"><img src="/manus-storage/artifex-product-graph-figure-crop_a970cb98.webp" alt="Artifex garment product graph figure" /><span className="core-label">GARMENT<br /><small>PRODUCT GRAPH</small></span></div><div className="node node-intent"><span>CREATIVE INTENT</span><small>origin</small></div><div className="node node-fit"><span>FIT / SIZING</span><small>body + ease</small></div><div className="node node-material"><span>MATERIAL / SUPPLY</span><small>drape + sourcing</small></div><div className="node node-pattern"><span>GEOMETRY</span><small>pattern + construction</small></div><div className="node node-docs"><span>PRODUCTION</span><small>quality + documentation</small></div></div>
    ...
    <main className={`journey-page immersive-journey mode-explore env-${key}`}>
      ...
      <section className="immersive-layout">
        ...
        <div className={`persistent-stage ${copilotPulse ? "copilot-changing" : ""}`} onPointerDown={(e) => { dragging.current = true; (e.currentTarget as HTMLElement).setPointerCapture(e.pointerId); }} onPointerMove={(e) => { if (dragging.current) setRotation((r) => r + e.movementX * .45); }} onPointerUp={() => { dragging.current = false; }}>
          ...
          {key === "versions" && <div className="collaboration-scene"><div className="collab-header"><span>COLLABORATION LAYER</span><b>Branch without losing the garment</b></div><div className="collab-canvas"><div className="collab-avatar avatar-a">CD<small>Creative</small></div><div className="collab-avatar avatar-b">TD<small>Technical</small></div><div className="collab-avatar avatar-c">PM<small>Pattern</small></div><div className="collab-garment"><Garment mode="mini" material="silver" /></div><i className="collab-line line-a" /><i className="collab-line line-b" /><i className="collab-line line-c" /><div className="collab-comment">“Keep the shoulder. Test the waist.”</div></div><div className="collab-versions"><span>V01 / CREATIVE</span><span>V02 / FIT TEST</span><span className="active">V03 / SHARED</span></div></div>}
          ...
          {key === "community" && <div className="community-scene"><div className="community-label"><span>COMMUNITY LAYER / AFTER RELEASE</span><b>Create a new lineage.</b><small>Discover, fork, remix, collaborate, or hire with attribution intact.</small></div><div className="lineage-network"><div className="lineage-origin">GARMENT<br />001</div><span>ORIGINAL<br /><small>approved</small></span><span>DRAPE 02<br /><small>exploration</small></span><span>FIT TEST<br /><small>branch</small></span><span>COLLAB<br /><small>shared</small></span><div className="lineage-lines" /></div></div>}
